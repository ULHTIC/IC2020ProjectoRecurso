...
* Ficheiro `.c` com código devidamente comentado e indentado:
    ...
    - O código deverá ser submetido na plataforma PANDORA [(2)](#ref2) até às **23:59 do dia 12 de Julho de 2021** no *contest* **IC2020PR**.
...
O projecto vale 50% da nota final e será cotado de 0 a 20 valores.
...
Este projecto tem nota mínima de 9.5 Valores.
